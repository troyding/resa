 ...
 * capabilities.
 */
public class TAExpServWC2PathRedis {
    ...
    public static void main(String[] args) throws Exception {
        ...
        builder.setBolt("splitP",
                ...
                .setNumTasks(10).shuffleGrouping("spout2Path", "Bolt-P");
        ...
        builder.setBolt("splitNotP",
                ...
                .setNumTasks(10).shuffleGrouping("spout2Path", "Bolt-NotP");
        ...
        builder.setBolt("counter", new TAWordCounter(() -> (long) (-Math.log(Math.random()) * 1000.0 / counter_mu)),
                ...
                .setNumTasks(10).shuffleGrouping("splitP").shuffleGrouping("splitNotP");
